                  ...
                  <div>
                    ...
                    <div class="relative">
                      <input
                        ...
                        maxlength="19"
                        class="w-full px-4 py-3 pl-12 border border-[#0081A7]/30 rounded-lg focus:ring-2 focus:ring-[#0081A7] focus:border-[#0081A7] outline-none"
                  ...
                  <div class="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="MM/YY"
                        maxlength="5"
                        class="w-full px-4 py-3 border border-[#0081A7]/30 rounded-lg focus:ring-2 focus:ring-[#0081A7] focus:border-[#0081A7] outline-none"
                        @input="e => {
