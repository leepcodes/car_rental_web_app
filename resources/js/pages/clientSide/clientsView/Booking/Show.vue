    ...
    <div class="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 py-8">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
          <!-- Image Gallery -->
          <Card class="overflow-hidden bg-white border-2 border-[#0081A7]">
            <div class="relative">
              <!-- Main Image -->
              ...
              <div class="absolute top-4 left-4 flex gap-2">
                <Badge class="bg-gradient-to-r from-[#0081A7] to-[#00AFB9] hover:from-[#0081A7]/90 hover:to-[#00AFB9]/90 text-white border-0">
                  {{ vehicle.type }}
                </Badge>
                ...
                <button
                  ...
                  :class="[
                    ...
                    currentImageIndex === index 
                      ? 'border-[#0081A7] scale-105' 
                      : 'border-neutral-300 hover:border-[#00AFB9] opacity-70 hover:opacity-100'
                  ]"
                >
                  <img
                    :src="image"
          ...
          <Card class="bg-white border-2 border-[#0081A7]">
            ...
            <CardContent>
              <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
                <div class="flex flex-col items-center p-4 bg-gradient-to-br from-[#0081A7]/10 to-[#00AFB9]/10 rounded-lg border border-[#0081A7]/20">
              ...
              <div class="mt-6 grid grid-cols-2 md:grid-cols-3 gap-4 pt-6 border-t border-neutral-200">
            ...
            <CardContent>
              <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
                ...
                >
                  ...
                  <span class="text-sm text-neutral-800">{{ feature }}</span>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <ul class="space-y-3">
                ...
                >
                  ...
                  <span class="text-neutral-800">{{ rule }}</span>
                </li>
              </ul>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                  ...
                  <button
                    @click="contactHost"
                    class="mt-4 w-full flex items-center justify-center gap-2 px-4 py-2 bg-gradient-to-r from-[#0081A7] to-[#00AFB9] border-2 border-[#0081A7] text-white rounded-lg hover:from-[#0081A7]/90 hover:to-[#00AFB9]/90 transition-colors font-medium"
                  >
