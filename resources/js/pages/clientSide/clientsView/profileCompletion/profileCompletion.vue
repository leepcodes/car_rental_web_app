        ...
        <CardHeader class="space-y-1 pb-6 bg-white border-b-2 border-[#0081A7]/20">
          <div class="flex items-center gap-3">
            <div class="p-2 bg-[#0081A7]/10 rounded-lg">
              <UserCheck class="h-6 w-6 text-[#0081A7]" />
            </div>
            <div class="flex-1">
              <CardTitle class="text-2xl text-neutral-900 font-['Roboto']">Complete Your Client Profile</CardTitle>
              <CardDescription class="text-base text-neutral-600">
                Just a few more details to get you started on your journey
              </CardDescription>
            </div>
            <Badge variant="secondary" class="hidden sm:flex bg-[#0081A7]/10 text-[#0081A7] border border-[#0081A7]/30">Step 1 of 1</Badge>
          </div>
        </CardHeader>
        ...
        <CardContent class="pt-6">
          <form @submit.prevent="submit" class="space-y-6">
            ...
            <button
              type="submit"
              :disabled="processing"
              class="w-full h-11 bg-gradient-to-r from-[#0081A7] to-[#00AFB9] text-white hover:from-[#0081A7]/90 hover:to-[#00AFB9]/90 rounded-md font-medium transition-all hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center font-['Roboto']"
            >
            ...
            <!-- Info Alert -->
            <Alert variant="default" class="border-2 border-[#0081A7]/30 bg-[#0081A7]/5">
              <Info class="h-4 w-4 text-[#0081A7]" />
