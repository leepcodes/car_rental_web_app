        ...
        <div class="flex items-start justify-between gap-2">
          <div class="flex-1 min-w-0">
            <CardTitle :class="[
              ...
              vehicle.available ? 'text-white group-hover:text-blue-400' : 'text-neutral-400'
            ]">
              {{ vehicle.name }}
            </CardTitle>
    ...
    <CardFooter class="pt-0 flex items-center justify-between">
      <div>
        <div class="flex items-baseline gap-1">
          <span :class="[
            'text-2xl font-bold',
            vehicle.available ? 'bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent' : 'text-neutral-400'
          ]">
